  ...
  return (
    <>
      <div className="flex justify-center flex-col gap-4 items-center text-white h-[44vh] px-5 md:px-0 text-xs md:text-base">
        ...
        <p className="text-center md:text-left">
          A place where your fans can buy you a butter. Unleash the power of
      ...
      <div className="text-white container mx-auto pb-32 pt-14 px-10">
        <h2 className="text-3xl font-bold text-center mb-14">
          Your Fans can buy you a butter
        </h2>
      ...
      <div className="text-white container mx-auto pb-32 pt-14 flex flex-col items-center justify-center">
        ...
        <div className="w-[90%] h-[40vh] md:w-[50%] md:h-[40vh] lg:w-[50%] lg:h-[40vh] xl:w-[50%] xl:h-[40vh]">
          <iframe
            ...
            src="https://www.youtube.com/embed/TWkWhI8KNh4?si=z4lfPnWLqyIgEX3S"
