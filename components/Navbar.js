    ...
    <nav className="bg-gray-900 shadow-xl shadow-white text-white flex justify-between items-center px-4 md:h-16">
      ...
      >
        <Image
          ...
          alt=""
        />
        <span className="text-xl md:text-base ml-4 my-3 md:my-0">
          BoostMeUp!
        </span>
      </Link>

      <div className="relative flex justify-center items-center ml-6 sm:ml-auto md:block gap-2 sm:gap-4">
        {session && (
          <>
            <button
            ...
            >
              ...
              <span className="inline sm:hidden">Options</span>
              <svg
            ...
            >
              ...
              >
                ...
                <li>
                  <Link
                    href={`/Creator/${session.user.name}`}
                    className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
                  >
                    As a Creator
                  </Link>
